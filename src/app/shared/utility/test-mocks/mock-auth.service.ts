...
export class MockAuthService {
  ...
  public readonly canManageClients = computed<boolean>(() => true);
  public hasRole(_roles: string | string[]): boolean {
    return true;
  }
  public readonly tokenClients = computed(() => [{ id: 'mock-client-1', name: 'Mock Client 1' }]);
  public readonly tokenSites = computed(() => [
    { id: 'mock-site-1', siteId: 'mock-site-1', name: 'Mock Site 1', code: 'MS1', clientId: 'mock-client-1' },
  ]);
  ...
  public readonly clientName = computed(() => 'Mock Client 1');
  public readonly siteName = computed(() => 'Mock Site 1');
